...
function disabilitysystems_stylesheets() {
...
add_action('wp_enqueue_scripts', 'disabilitysystems_stylesheets');
// for footer
function disabilitysystems_stylesheets_footer() {
...
add_action('get_footer', 'disabilitysystems_stylesheets_footer');
...
function disabilitysystems_menus() {
...
add_action('after_setup_theme', 'disabilitysystems_menus');
